...
async function fetchRequests() {
    try {
        ...
        requests = (data.requests || []).filter(r => r.category_id == 4 || r.category_name === "Air Conditioning");
...
async function loadTechniciansToDetailModal(selectedName = "") {
    ...
    data = data.filter(tech => tech.category_id == 4 || tech.category_name === "Air Conditioning");
